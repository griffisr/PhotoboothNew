  ...
  class Button extends HTMLElement {
    ...
    <body class="page-template-default page page-id-24290 fl-builder fl-framework-bootstrap fl-preset-default fl-full-width" itemscope="itemscope" itemtype="https://schema.org/WebPage">
      ...
      <div class="fl-page">
                ...
                <div class="col-sm-12 col-md-3 fl-page-logo-wrap">
                  <div class="fl-page-header-logo">
                    <a href="index.html"><img
                        ...
                        data-retina="Images/comingsoon.png"
                        title=""
                        alt="Coming Soon"
                    /></a>
                  </div>
            ...
            <div class="fl-page-bar-row row">
              <div class="col-sm-6 col-md-6 text-left clearfix">
                <div class="fl-page-bar-text fl-page-bar-text-1">
                  Capturing Michigan memories since 2022
                </div>
              </div>
              <div class="col-sm-6 col-md-6 text-right clearfix">
                <div class="fl-page-bar-text fl-page-bar-text-2">
                  <div style="font-size: 120%">
                    <strong
                      >Call or TXT:
                      <a href="tel:1-734-236-1600">(xxx) xxx-xxxx</a></strong
                    >
                  </div>
                </div>
              </div>
        ...
        <!------------------------------Large Nav Bar--------------------------------------------------->
        <header
          class="fl-page-header fl-page-header-primary fl-page-nav-right fl-page-nav-toggle-icon fl-page-nav-toggle-visible-mobile"
          itemscope="itemscope"
                ...
                <div class="col-sm-12 col-md-4 fl-page-header-logo-col">
                  <div class="fl-page-header-logo" itemscope="itemscope" itemtype="https://schema.org/Organization">
                    <a href="index.html" itemprop="url">
                      <img loading="false" data-no-lazy="1" class="fl-logo-img" itemscope itemtype="https://schema.org/ImageObject"  src="Images/comingsoon.png" data-retina="Images/comingsoon.png" title="" alt="Facetime Photo Booths"/>
                    </a>
                  </div>
                </div>
